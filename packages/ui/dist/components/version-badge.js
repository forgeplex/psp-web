...
export function VersionBadge({ version = 'dev', buildTime, storageKey = '', }) {
    ...
    return (_jsxs("div", { ref: badgeRef, onMouseDown: handleMouseDown, onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false), style: {
      ...
      `, children: [_jsx(GripVertical, { className: "w-3 h-3 opacity-50" }), _jsx("span", { className: "font-semibold", children: version }), buildTime && isHovered && (_jsx("span", { className: "text-white/60 text-[10px]", children: new Date(buildTime).toLocaleString() })), _jsx("button", { onClick: handleClose, className: "ml-1 p-0.5 rounded hover:bg-white/20 transition-colors", title: "\u5173\u95ED (Ctrl+Shift+V \u91CD\u65B0\u663E\u793A)", children: _jsx(X, { className: "w-3 h-3" }) })] }));
}
