...
export function PageHeader({ title, subtitle, breadcrumb, extra }) {
    return (_jsxs("div", { style: { marginBottom: 24 }, children: [breadcrumb && breadcrumb.length > 0 && (_jsx(Breadcrumb, { style: { marginBottom: 8 }, items: breadcrumb.map((item) => ({
                ...
                })) })), _jsxs("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between' }, children: [_jsxs(Space, { direction: "vertical", size: 0, children: [_jsx(Title, { level: 4, style: { margin: 0, fontSize: 20, fontWeight: 600 }, children: title }), subtitle && (_jsx("span", { style: { color: '#71717A', fontSize: 14 }, children: subtitle }))] }), extra && _jsx(Space, { children: extra })] })] }));
}
